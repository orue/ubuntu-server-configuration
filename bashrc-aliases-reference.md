...
| Alias  | Command       | Description                                                                      |
| ------ | ------------- | -------------------------------------------------------------------------------- |
| `svim` | `sudo -E vim` | Edit files as root while preserving your user environment and nvim configuration |
...
Without `-E`, running `sudo vim` would use root's environment and configuration, giving you a different (often minimal) editing experience.
